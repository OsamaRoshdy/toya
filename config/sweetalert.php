...
return [
    ...
    */
    ...
    | Animation
    |--------------------------------------------------------------------------
    | Custom animation with [Animate.css_en](https://daneden.github.io/animate.css/)
    ...
    */
    ...
    'animatecss' => env('SWEET_ALERT_ANIMATECSS', 'https://cdn.jsdelivr.net/npm/animate.css_en'),
