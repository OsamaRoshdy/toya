...
@section('content')
    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        ...
        <div class="card-body">
            <!--begin::Form-->
            {!! Form::open(['route'=>'dashboard.'. $module.'.store','id'=>'kt_form','method'=>'post', 'files' => false] ) !!}
            <div class="row">
                <div class="col-xl-8">
                    <div class="my-5">
                                                        ...
                                                        <div class="checkbox-inline">
                                                            @foreach($value as $permission)
                                                                <label class="checkbox checkbox-success">
                                                                    <input type="checkbox" name="permissions[]" value="{{ $permission . '_' . $key }}" {{ old('permissions') && in_array($permission . '_' . $key, old('permissions')) ? 'checked' : '' }}>
